...
export interface ApiPageStatiquePageStatique
  extends Struct.CollectionTypeSchema {
  collectionName: 'pages_statiques';
  info: {
    description: '';
    displayName: 'Page Statique';
    pluralName: 'pages-statiques';
    singularName: 'page-statique';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::page-statique.page-statique'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titre: Schema.Attribute.String;
...
export interface ApiPodcastPodcast extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fichier_audio: Schema.Attribute.Media<'audios'>;
    image: Schema.Attribute.Media<'images'>;
    invite: Schema.Attribute.String;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::podcast.podcast'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::page-statique.page-statique': ApiPageStatiquePageStatique;
